...
#include "MetaShoot_DraggableItemEditor.h"
...
void UMetaShoot_DraggableItemEditor::GetMouseLocationWorld()
{
...
void UMetaShoot_DraggableItemEditor::GetMouseTimerFunctionBP()
{
	FViewport* activeViewport = GEditor->GetActiveViewport();
	FEditorViewportClient* editorViewClient = (activeViewport != nullptr) ? (FEditorViewportClient*)activeViewport->GetClient() : nullptr;
	if (editorViewClient)
...
void UMetaShoot_DraggableItemEditor::SelectSpawnedActor()
{
